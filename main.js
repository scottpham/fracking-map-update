...
//wellLocations is a global var with geojson dat
...
function clickToControl(e) {
	var layer = e.target;
	wellLayer.setStyle({color: "black"});
	// e.target.popup
...
info.update = function(data) {
	...
	this._div.innerHTML = (data ? ('<div class="target-info"><p>This well is disposing its waste water into a clean aquifer protected by the EPA.</p><p> It is operated by ' + data.feature.properties.operator + ".</p><p>Check the Department of Conservation's " + '"Well Finder" has <a href="' + data.feature.properties.url + '" target="_blank">for more info on this well.</a></p></div><div id="slide-control" class="buttons btn-group btn-group-justified"> <a class="slide-up btn btn-primary"><span class="glyphicon glyphicon-chevron-up"> </span></a> <a class="slide-down btn btn-primary"> <span class="glyphicon glyphicon-chevron-down"></span></a> </div>' ) : '<div class="target-info"><h4><strong>Each dot is a well. Click for more info.</strong></h4></div><div id="slide-control" class="buttons btn-group btn-group-justified"> <a class="slide-up btn btn-primary"><span class="glyphicon glyphicon-chevron-up"> </span></a> <a class="slide-down btn btn-primary"> <span class="glyphicon glyphicon-chevron-down"></span></a> </div>');
